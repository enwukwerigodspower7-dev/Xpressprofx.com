...
// ---------------------------------------------------------------------------
// Support Chat (visitor-facing, session-keyed, no auth required)
// ---------------------------------------------------------------------------

export interface SupportChatMsg {
  id: string;
  sessionId: string;
  userId: string | null;
...
/** keyed by sessionId → array of messages ordered by createdAt */
export const supportChatMessages = new Map<string, SupportChatMsg[]>();
/** keyed by sessionId → session object */
export const supportChatSessions = new Map<string, SupportChatSession>();
